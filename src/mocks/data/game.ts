...
export const MOCK_GAME_DETAILS: GameDetails = {
  ...
  support: {
    id: 1,
    url: 'https://www.heishenhua.com/support',
    email: 'cs@gamesci.com.cn',
  },
  comments: [
    {
      id: 1,
  ...
  critics: [
    {
      ...
      posted_at: '2024-08-19T00:00:00.000Z',
      critic: {
        id: 1,
        name: 'Metacritic',
  ...
  stores: [
    ...
    },
    {
      ...
      store_game_id: 'black-myth-wukong-87a72b',
      price: 22999,
      store: {
        id: 2,
        name: 'Epic Games',
